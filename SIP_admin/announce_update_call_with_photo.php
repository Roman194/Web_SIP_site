...
$announce_image = $_POST['announce_image'];

$query = "UPDATE `sip_announces` SET `announce_title`='".$announce_title."',`announce_text`='".$announce_text."',`announce_image`='".$announce_image."',`announce_button_text`='".$announce_button."' WHERE `announce_id`='".$announce_id."'";
